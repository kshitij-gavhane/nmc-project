<?php  
 ...
 $query ="select invoice_id,owner_name,date, total,payment_mode from invoice";
    ...
    <div id="wrapper">
		...
		echo '  
          ...
          <td>'.$row["payment_mode"].'</td> 
                <td>
                    <div class="badge badge-partial badge-partial-alt">'.$row["payment_mode"].'</div>
                </td>
                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                            <a class="dropdown-item" name="" href="./paym_success.html"><i
                                                    class="bx bxs-pencil mr-2"></i> View</a>
	 ...
	 ?>  
                        <!-- <tbody>
                            <tr>
                                ...
                                <td>&#8377; 17573.00</td>
                                <td>
                                    <div class="badge badge-success badge-success-alt">Cash</div>
                                </td>
                                <td>
                                    <div class="dropdown">
                                        <button class="btn btn-sm btn-icon" type="button" id="dropdownMenuButton2"
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                                            <a class="dropdown-item" href="./paym_success.html"><i
                                                    class="bx bxs-pencil mr-2"></i> View </a>
                                            <a class="dropdown-item text-danger" href="#"><i
                                                    class="bx bxs-trash mr-2"></i> Remove</a>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td>&#8377; 15643.00</td>
                                <td>
                                    <div class="badge badge-partial badge-partial-alt">Online</div>
                                </td>
                                <td>
                                    <div class="dropdown">
                                        <button class="btn btn-sm btn-icon" type="button" id="dropdownMenuButton2"
